export default defineEventHandler(async (event) => {
    const { _id, _id_kos:id_kos, name, description, available:_available, image, price, price_harian, price_harian_on } = await readBody(event)
    ...
    try {
        ...
        .updateOne({_id}, {id_kos, name, description, image, price:_price, price_harian:_price_harian})
